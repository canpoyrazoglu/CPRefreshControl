...
/// Speed of the animation (not in any particular unit). Default is 6. Experiment with this value to see its effect.
...
/// Style of the impact generated by beginning a refresh. This value will be ignored on platforms prior to iOS 10. Default is light impact, which creates a subtle haptic feedback on refresh.
